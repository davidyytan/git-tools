...
When an incident does occur, it is important to report it promptly. For code of conduct concerns, contact the maintainer directly at `david.tan@davidyytan.com`. Do not use a public GitHub issue for private or sensitive conduct reports.
